...
export const wordDatabase: Record<string, Record<string, Array<WordClue>>> = {
  ...
  ciencia: {
    ...
    dificil: [
      {
        word: "MITOCONDRIA",
        clue: "Organela responsável pela respiração celular",
      },
      { word: "RIBOSSOMO", clue: "Organela que sintetiza proteínas" },
      {
        word: "FOTOSSINTESE",
        clue: "Processo de produção de glicose pelas plantas",
      },
      ...
      {
        word: "ESTEQUIOMETRIA",
        clue: "Cálculo de quantidades em reações químicas",
      },
      { word: "HIBRIDIZACAO", clue: "Mistura de orbitais atômicos" },
      {
        word: "ELETROFORESE",
        clue: "Separação de moléculas por carga elétrica",
      },
      ...
      { word: "TERMODINAMICA", clue: "Estudo do calor e energia" },
      {
        ...
        clue: "Interação entre eletricidade e magnetismo",
      },
  ...
  geografia: {
    ...
    medio: [
      ...
      {
        word: "LONGITUDE",
        clue: "Distância angular do meridiano de Greenwich",
      },
  ...
  esportes: {
    ...
    medio: [
      ...
      {
        word: "HANDBALL",
        clue: "Esporte parecido com futebol mas com as mãos",
      },
      {
        word: "RUGBY",
        clue: "Esporte violento parecido com futebol americano",
      },
