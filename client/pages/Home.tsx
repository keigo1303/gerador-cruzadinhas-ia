  ...
  const activities = [
    {
      ...
      description: 'Crie cruzadinhas personalizadas com palavras e dicas. Perfeito para atividades educativas.',
      icon: Grid3x3,
      path: '/cruzadinha',
      color: 'from-blue-600 to-purple-600',
      bgColor: 'from-blue-50 to-purple-50',
      iconColor: 'text-blue-600',
      features: ['Modo Manual e IA', 'PDF com respostas', 'Temas educativos', 'Até 20 palavras']
    },
    {
      id: 'caca-palavras',
      title: 'Gerador de Caça-Palavras',
      description: 'Crie caça-palavras envolventes e desafiadores. Ideal para exercitar o vocabulário.',
      icon: Search,
      path: '/caca-palavras',
      color: 'from-emerald-600 to-teal-600',
      bgColor: 'from-emerald-50 to-teal-50',
      iconColor: 'text-emerald-600',
      features: ['Palavras em todas direções', 'Grade customizável', 'Banco de palavras IA', 'Até 25 palavras']
    }
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Atividades Disponíveis</h2>
            <p className="text-gray-600">Escolha a atividade que deseja criar</p>
          </div>
            ...
            {activities.map((activity) => {
              ...
              return (
                ...
                >
                  ...
                  <CardHeader className={`bg-gradient-to-br ${activity.bgColor} pb-4`}>
                    <div className="flex items-center justify-between mb-4">
                      <div className={`p-3 rounded-xl bg-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  <CardContent className="p-6 bg-white">
                    ...
                    <div className="space-y-3 mb-6">
                      <h4 className="font-semibold text-gray-800 text-sm uppercase tracking-wide">Características:</h4>
                      <div className="grid grid-cols-2 gap-2">
                        {activity.features.map((feature, index) => (
                          <div key={index} className="flex items-center text-sm text-gray-600">
                            <div className={`w-2 h-2 rounded-full bg-gradient-to-r ${activity.color} mr-2`}></div>
                            {feature}
                          </div>
                        ))}
                      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Por que usar nossos geradores?</h3>
              <p className="text-gray-600">Ferramentas desenvolvidas especialmente para educadores</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-800 mb-2">IA Inteligente</h4>
                <p className="text-gray-600 text-sm">Geração automática de palavras por tema e dificuldade</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Baixe suas atividades em PDF com ou sem respostas</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-800 mb-2">Para Educadores</h4>
                <p className="text-gray-600 text-sm">Interface intuitiva pensada para professores</p>
              </div>
            </div>
          </div>
        </div>
