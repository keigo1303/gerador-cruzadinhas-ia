...
import { Trash2, Download, FileText, FileCheck, Sparkles, Plus, X, Bot, User, Search } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center mt-4 gap-4">
            ...
            <Link 
              to="/caca-palavras" 
              className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
